...
class _HomeShellState extends ConsumerState<HomeShell> {
  ...
  bool _onNavKey(KeyEvent event) {
    ...
    // F10 DOIM bo'limlarni aylantiradi — savatda mahsulot bor-yo'qligiga
    // bog'liq emas. (Avval savat to'la bo'lsa F10 Click Pass'ga qoldirilardi,
    // lekin Click Pass F1'ga ko'chgach hech kim ushlamay F10 o'lik qolgandi.)
